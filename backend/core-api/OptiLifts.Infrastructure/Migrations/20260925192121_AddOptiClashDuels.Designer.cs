...
namespace OptiLifts.Infrastructure.Migrations
{
    ...
    [Migration("20260925192121_AddOptiClashDuels")]
    partial class AddOptiClashDuels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OptiLifts.Domain.Clash.Arena", b =>
                {
            ...
            modelBuilder.Entity("OptiLifts.Domain.Clash.ArenaInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("arena_invites", (string)null);
                });

            modelBuilder.Entity("OptiLifts.Domain.Clash.ArenaMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ArenaId", "UserId")
                        .IsUnique();

                    b.ToTable("arena_members", (string)null);
                });

            modelBuilder.Entity("OptiLifts.Domain.Clash.AthleteProfileKudos", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("kudos_id");
                    ...
                    b.HasIndex("TargetUserId", "SenderUserId")
                        .IsUnique();

                    b.ToTable("athlete_profile_kudos", (string)null);
                });

            modelBuilder.Entity("OptiLifts.Domain.Clash.AthleteSeasonSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("Bench1RM")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("bench_1rm");
                    ...
                    b.Property<decimal>("Deadlift1RM")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("deadlift_1rm");
                    ...
                    b.Property<DateTime>("LastWorkoutDate")
                        .HasColumnType("date")
                        .HasColumnName("last_workout_date");

                    b.Property<int>("RankTrend")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("rank_trend");

                    b.Property<string>("SeasonKey")
                        .IsRequired()
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)")
                        .HasColumnName("season_key");

                    b.Property<decimal>("Squat1RM")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("squat_1rm");
                    ...
                    b.Property<decimal>("TotalE1RM")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(7, 2)
                        .HasColumnType("numeric(7,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("total_e1rm");

                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");

                    b.Property<decimal>("WeeklyVolumeKg")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("weekly_volume_kg");

                    b.HasKey("Id");

                    b.HasIndex("SeasonKey", "Bench1RM");

                    b.HasIndex("SeasonKey", "Deadlift1RM");

                    b.HasIndex("SeasonKey", "Squat1RM");

                    b.HasIndex("SeasonKey", "WeeklyVolumeKg");

                    b.HasIndex("UserId", "SeasonKey")
                        .IsUnique();

                    b.HasIndex("SeasonKey", "IsOptedIn", "Gender", "BodyweightKg", "DotsScore");

                    b.ToTable("athlete_season_snapshots", (string)null);
                });

            modelBuilder.Entity("OptiLifts.Domain.Clash.ClashActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ArenaId", "CreatedAt");

                    b.ToTable("clash_activities", (string)null);
                });

            modelBuilder.Entity("OptiLifts.Domain.Clash.ClashActivityKudos", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ActivityId", "SenderUserId")
                        .IsUnique();

                    b.ToTable("clash_activity_kudos", (string)null);
                });

            modelBuilder.Entity("OptiLifts.Domain.Clash.Duel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("ChallengerBaselineValue")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("challenger_baseline_value");

                    b.Property<decimal>("ChallengerCurrentValue")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("challenger_current_value");

                    b.Property<Guid>("ChallengerUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("challenger_user_id");
                    ...
                    b.Property<decimal?>("RivalBaselineValue")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("rival_baseline_value");

                    b.Property<decimal>("RivalCurrentValue")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("rival_current_value");

                    b.Property<Guid>("RivalUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("rival_user_id");
            ...
            modelBuilder.Entity("OptiLifts.Domain.Clash.DuelTimelineEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DuelId", "CreatedAt");

                    b.ToTable("duel_timeline_events", (string)null);
                });

            modelBuilder.Entity("OptiLifts.Domain.Clash.FriendRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OptiLifts.Domain.Clash.Friendship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("friendships", null, t =>
                        {
                            t.HasCheckConstraint("CK_friendships_user_order", "user_id1 < user_id2");
                        });
                });
            ...
            modelBuilder.Entity("OptiLifts.Domain.Users.User", b =>
                {
                    ...
                    b.Property<string>("DuelInvitePrivacy")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("Friends")
                        .HasColumnName("duel_invite_privacy");
                    ...
                    b.Property<bool>("GlobalLeaderboardOptIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("global_leaderboard_opt_in");
            ...
            modelBuilder.Entity("OptiLifts.Domain.Clash.ArenaInvite", b =>
                {
                    b.HasOne("OptiLifts.Domain.Clash.Arena", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OptiLifts.Domain.Clash.ClashActivityKudos", b =>
                {
                    b.HasOne("OptiLifts.Domain.Clash.ClashActivity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OptiLifts.Domain.Clash.DuelTimelineEvent", b =>
                {
                    b.HasOne("OptiLifts.Domain.Clash.Duel", null)
                        .WithMany()
