...
test.describe('Workout Detail Page', () => {
    test.beforeEach(async ({ page }) => {
        await page.goto('/workouts/33333333-3333-3333-3333-333333333333/logs/58597dd0-e02c-416c-a4b0-cba560f21045');//push day A's workoutID with it's workoutLogId
        await page.waitForLoadState('networkidle');
    });

    test('User can view a workout log\'s details', async ({ page }) => {
