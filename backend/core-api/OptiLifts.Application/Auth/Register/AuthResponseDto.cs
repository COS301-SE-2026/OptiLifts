...
public sealed record AuthUserDto(Guid Id, string DisplayName, string Email, DateTime CreatedAt, bool Metric, bool lightTheme, string? Sex = null, string? ProfileImageUrl = null);
